	          ...
	          <button type="button"
	            ...
	            <span class="icon-bar"></span>ss
      	  	  ...
      	  	  <div class="navbar-collapse navbar-left ">
				      ...
				      <li <?php if(isset($_SESSION['page'])&&$_SESSION['page'] == "request") echo "class = 'active'";?> ><a href="../Controller/Dashboard.php?request">Request</a></li>
				      ...
				      <li <?php if(isset($_SESSION['page'])&&$_SESSION['page'] == "employee") echo "class = 'active'";?> ><a href="../Controller/Dashboard.php?employee">Employee</a></li>
